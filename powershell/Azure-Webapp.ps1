...
Connect-AzAccount -subscription "99be1db5-4f4a-4f12-9bb7-fc76e26d9a2e"
...
$EU_gitrepo="https://github.com/eoncu3841/EU-AZURE-WEBAPP.git"
$EA_gitrepo="https://github.com/eoncu3841/EA-AZURE-WEBAPP.git"
...
$tm = New-AzTrafficManagerProfile -Name 'MyTrafficManagerProfile' -ResourceGroupName $rgname1 `
  -TrafficRoutingMethod Priority -RelativeDnsName Finserve -Ttl 60 `
